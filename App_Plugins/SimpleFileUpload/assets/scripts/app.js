...
angular.module("umbraco").controller('SimpleFileUploadController', function ($scope, $rootScope, fileApiService) {
    ...
    $scope.uploadFile = function () {
        if (!$scope.isUploading) {
            if ($scope.file) {
                ...
                console.info("Please select a file to upload.");
                $scope.isUploading = false;
            }
        }
    };
...
angular.module("umbraco.resources").factory("fileApiService", function ($http) {
    ...
    fileApiFactory.uploadFileToServer = function (file) {
        ...
        return $http({
            method: 'POST',
            url: "backoffice/SimpleFileUpload/FileUploadApi/UploadFileToServer",
